        ...
        if ($resultFavorit && mysqli_num_rows($resultFavorit) > 0) {
            while ($rowFavorit = mysqli_fetch_assoc($resultFavorit)) {
                echo "<div style='margin: 20px;'>
                        ...
                        <a href='keranjang.php?id={$rowFavorit['id']}' style='background-color: red; color: white; text-decoration: none;'>Pesan</a>
                      </div>";
            }
        } else {
        ...
        if ($resultTerbaru && mysqli_num_rows($resultTerbaru) > 0) {
            while ($rowTerbaru = mysqli_fetch_assoc($resultTerbaru)) {
                echo "<div style='margin: 20px;'>
                        ...
                        <a href='keranjang.php?id={$rowTerbaru['id']}' style='background-color: red; color: white; text-decoration: none;'>Pesan</a>
                      </div>";
            }
        } else {
